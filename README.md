About langchain-openai-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langchain-openai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langchain-openai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langchain-openai
# for installing globally
pixi global install langchain-openai
```
...
It is possible to list all of the versions of `langchain-openai` available on your platform:
...
```
pixi search langchain-openai --channel conda-forge
```
